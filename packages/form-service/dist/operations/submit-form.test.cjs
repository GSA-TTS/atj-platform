...
// ../../node_modules/.pnpm/magic-string@0.30.9/node_modules/magic-string/dist/magic-string.es.mjs
...
var BitSet, Chunk, btoa2, SourceMap, toString2, wordRegex, Mappings, n, warned, MagicString, hasOwnProp, Bundle;
  ...
  taskFn.each = function(cases, ...args) {
    ...
    return (name, optionsOrFn, fnOrOptions) => {
      ...
      cases.forEach((i, idx) => {
        const items = Array.isArray(i) ? i : [i];
        if (fnFirst) {
          arrayOnlyCases ? test22(formatTitle(_name, items, idx), () => handler(...items), options) : test22(formatTitle(_name, items, idx), () => handler(i), options);
        } else {
          arrayOnlyCases ? test22(formatTitle(_name, items, idx), options, () => handler(...items)) : test22(formatTitle(_name, items, idx), options, () => handler(i));
        }
      });
      this.setContext("each", void 0);
    };
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/global.CkGT_TMy.js
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/index.SMVOaj7F.js
function getRunMode() {
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/benchmark.yGkUTKnC.js
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/run-once.Olz_Zkd8.js
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/_commonjsHelpers.jjO7Zipk.js
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/tasks.IknbGB2n.js
function getFullName(task, separator = " > ") {
  return getNames(task).join(separator);
}

// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/base.5NT-gWu5.js
function isChildProcess() {
  return typeof process !== "undefined" && !!process.send;
}

// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/date.Ns1pGd_X.js
var RealDate = Date;
var now2 = null;
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/vi.YFlodzP_.js
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/vendor/index.dI9lHwVn.js
...
// ../../node_modules/.pnpm/vitest@1.6.0_@types+node@20.11.16_@vitest+ui@1.2.2/node_modules/vitest/dist/index.js
var expectTypeOf = dist.expectTypeOf;

// src/operations/submit-form.test.ts
var import_forms4 = require("@atj/forms");

// src/context/test/index.ts
var import_forms3 = require("@atj/forms");
...
var createTestStorage = (testData) => {
  ...
  const storage = {
    ...
    key(index) {
      const keys2 = Object.keys(records);
      return keys2[index] || null;
    }
  };
...
// src/context/test/index.ts
var createTestFormService = (testData = {}) => {
  return createBrowserFormService({
    config: import_forms3.defaultFormConfig,
...
describe("submitForm", () => {
  it("succeeds with empty form", async () => {
    const service = createTestFormService({
      "test-form": (0, import_forms4.createForm)({ title: "test", description: "description" })
    });
    const formResult = service.getForm("test-form");
    if (!formResult.success) {
      throw new Error("form not found");
    }
    const session = (0, import_forms4.createFormSession)(formResult.data);
