...
__export(src_exports, {
  AL_NAME_TEST_DATA: () => AL_NAME_TEST_DATA,
  SAMPLE_DOCUMENTS: () => SAMPLE_DOCUMENTS,
  UD105_TEST_DATA: () => UD105_TEST_DATA,
  ...
  getSuggestedFormElementsFromCache: () => getSuggestedFormElementsFromCache,
...
0 && (module.exports = {
  ...
  getSuggestedFormElementsFromCache,
