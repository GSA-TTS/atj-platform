...
// src/__tests__/doj-pardon-marijuana.test.ts
describe("DOJ Pardon Office marijuana pardon application form", () => {
  it("produces valid PDF from imported PDF", async () => {
    ...
    globalExpect(getFieldByName(fields, "Gender")).toEqual({
      label: "Gender",
      name: "Gender",
      maxLength: void 0,
      required: false,
    ...
    globalExpect(getFieldByName(fields, "Docket No")).toEqual({
      label: "Docket No",
      name: "Docket No",
      maxLength: void 0,
      required: false,
...
var getFieldByName = (fields, name) => {
